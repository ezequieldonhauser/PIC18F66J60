...
#define MY_DEFAULT_IP_ADDR_BYTE3        (25ul)
...
// =============================================================================
    ...
    #define TCP_CONFIGURATION
        ...
        {   //inicialização das variaveis dos tipos de sockets
            ...
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 150, 150},
